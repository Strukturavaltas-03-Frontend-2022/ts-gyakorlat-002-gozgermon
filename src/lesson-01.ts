export default class calculator {
     ...
     * 
     */
     users: {name:string,email:string}[]=[{name:"a",email:"b"},{name:"a",email:"b"},{name:"a",email:"b"}]
     ...
     */    
     products: {name:string,price:number,stock:number}[]=[{name:"string",price:2,stock:2},{name:"string",price:2,stock:2}]
    
    /** 
     * Inicializálj egy tuple típust, azaz adj neki értéket is.
     * @type {Tuple} role - number, string, boolean. 
     */
     role:[number,string,boolean]=[2,"df",false]
